...
//}
const OrderCOD = async (orderDetails: { name: string; address: string; phone: number; pincode: number; paymentMode: "cod" | "online"; totalAmount: number; }) => {
  return axios.post('/order/placeordercod',orderDetails);
}
const RazorpayCOD = async (orderDetails: { name: string; address: string; phone: number; pincode: number; paymentMode: "cod" | "online"; totalAmount: number; }) => {
